    ...
    <Layout title="Privacy" href="/about/">
        <ContentBox>
            ...
            <Typography variant="body1" component="ul">
                <li>
                    Stores your app preferences and data (such as favourites) <strong>only</strong>{' '}
                    in your web browser (such as Firefox, Chrome or Safari), on your personal
                    device, and never stores or shares that data with any external servers or
                    services.
                </li>
                <li>
                ...
                <li>
                    Does not itself use cookies however cookies may be added by our server provider,
            ...
            <P>
                If you use an Android device and downloaded this app from the Google Play store then
                Google will likely be tracking your usage of this app (such as installation date,
                deletion date, launch times and session duration). Please see:
            </P>
            <Typography variant="body1" component="ul">
                <li>
